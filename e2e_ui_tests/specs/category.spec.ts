  ...
  test.describe("Create Category", () => {
    test.describe("Happy Path", () => {
      ...
      test("should create a new expense category with parent category", async ({}) => {
        ...
        const childCategoryData = await generateCategory(
          "EXPENSE",
          categoryData.name,
        );
    ...
    test.describe("Unhappy Path", () => {
      test("should not create a category with the same name", async ({
        page,
      }) => {
        const expenceCategoryData = await generateCategory("EXPENSE");
        await category.createCategory({ ...expenceCategoryData });
      ...
      test("should not create a category with the same name (different category type)", async ({
        page,
      }) => {
        const expenceCategoryData = await generateCategory("EXPENSE");
        await category.createCategory({ ...expenceCategoryData });
      ...
      test("should not create a category with a third parent category", async ({
        page,
      }) => {
        const incomeCategoryData = await generateCategory("INCOME");
        await category.createCategory({ ...incomeCategoryData });
        ...
        const incomeCategoryData2 = await generateCategory(
          "INCOME",
        ...
        const incomeCategoryData3 = await generateCategory(
          "INCOME",
          incomeCategoryData.name,
        );
        ...
        await category.createCategoryAndExpectFailure({
          ...
          toastErrorMessage:
            "Maximum category depth of 2 levels exceeded. Categories can only have 2 levels: Root → Level 1 → Level 2 (max)",
          formErrorMessage:
            "Maximum category depth of 2 levels exceeded. Categories can only have 2 levels: Root → Level 1 → Level 2 (max)",
        });
      });
  ...
  test.describe("Edit Category", () => {
    test.describe("Happy Path", () => {
      test("should edit an existing category (name only)", async () => {
        ...
        await category.editCategory(incomeCategoryData.name, {
      ...
      test("should add parent category", async () => {
        ...
        await category.editCategory(incomeCategoryData2.name, {
          parentCategoryName: incomeCategoryData.name,
        });
        await category.expectCategoryCreated({
          ...incomeCategoryData2,
          parentCategoryName: incomeCategoryData.name,
        });
      });
    ...
    test.describe("Unhappy Path", () => {
      ...
      test("should not edit the category with third parent category", async ({
        page,
      }) => {
        const incomeCategoryData = await generateCategory("INCOME");
        await category.createCategory({ ...incomeCategoryData });
  ...
  test.describe("Delete Category", () => {
    ...
    test.describe("Unhappy Path", () => {
      test("should not delete a category with children", async () => {
        ...
        const childIncomeCategoryData = await generateCategory(
          "INCOME",
          incomeCategoryData.name,
        );
        ...
        // The delete button is disabled for categories with children
        await category.expectDeleteButtonDisabled(incomeCategoryData.name);
      });
    });
  });
});
