...
export const TutorialProvider: React.FC<TutorialProviderProps> = ({ children }) => {
  ...
  const shouldShowTutorial = user !== null && user.tutorial_version < CURRENT_TUTORIAL_VERSION;
  ...
  const completeTutorial = useCallback(async () => {
    ...
    try {
      const result = await userApi.updateTutorial({ tutorial_version: CURRENT_TUTORIAL_VERSION });
      if (!('error' in result)) {
