...
export class DebtApiClient {
  ...
  async createDebt(debt: DebtCreate): Promise<DebtResponse | ApiError> {
    try {
      const response = await this.httpClient.post<DebtResponse>(
        "/debts/",
        debt,
      );
      return response;
    } catch (error) {
      logger.error("DebtApiClient: Error creating debt:", error);
  ...
  async getDebts(
    ...
    try {
      ...
      const response = await this.httpClient.get<DebtResponse[]>(
        `/debts/?${params}`,
      );
      return response;
    } catch (error) {
      logger.error("DebtApiClient: Error fetching debts:", error);
  ...
  async getDebt(debtId: number): Promise<DebtResponse | ApiError> {
    try {
      ...
      logger.error("DebtApiClient: Error fetching debt:", error);
  ...
  async updateDebt(
    ...
    try {
      const response = await this.httpClient.put<DebtResponse>(
        `/debts/${debtId}`,
        debt,
      );
      return response;
    } catch (error) {
      logger.error("DebtApiClient: Error updating debt:", error);
  ...
  async deleteDebt(debtId: number): Promise<boolean | ApiError> {
    try {
      ...
      logger.error("DebtApiClient: Error deleting debt:", error);
  ...
  ): Promise<DebtPaymentResponse | ApiError> {
    try {
      const response = await this.httpClient.post<DebtPaymentResponse>(
        `/debts/${debtId}/payments/`,
        payment,
      );
      return response;
    } catch (error) {
      logger.error("DebtApiClient: Error creating payment:", error);
  ...
  async getPayments(
    ...
    try {
      ...
      const response = await this.httpClient.get<DebtPaymentResponse[]>(
        `/debts/${debtId}/payments/?${params}`,
      );
      return response;
    } catch (error) {
      logger.error("DebtApiClient: Error fetching payments:", error);
  ...
  async getDebtSummary(): Promise<DebtSummary | ApiError> {
    try {
      const response =
        await this.httpClient.get<DebtSummary>("/debts/summary/");
      return response;
    } catch (error) {
      logger.error("DebtApiClient: Error fetching debt summary:", error);
