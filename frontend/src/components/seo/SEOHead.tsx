...
export const SEOConfigs = {
  ...
  about: {
    title: 'О нас - FinFlow',
    description: 'Узнайте о FinFlow - умном приложении для учета финансов с автоматической категоризацией трат и парсингом банковских выписок.',
    keywords: 'о нас, команда FinFlow, финансовая аналитика, учет финансов'
  },
  
  features: {
    title: 'Возможности - FinFlow',
    description: 'Откройте для себя все возможности FinFlow: парсинг банковских выписок, автоматическая категоризация, аналитика и многое другое.',
    keywords: 'возможности, функции, парсинг банковских выписок, автоматическая категоризация трат, финансовая аналитика'
  },
  
  pricing: {
    title: 'Тарифы и цены - FinFlow',
    description: 'Выберите подходящий тарифный план для управления вашими финансами. Бесплатный план и премиум возможности.',
    keywords: 'тарифы, цены, премиум план, бесплатный план, финансовая аналитика'
  },
  
  contact: {
    title: 'Связаться с нами - FinFlow',
    description: 'Свяжитесь с командой FinFlow. Мы всегда готовы помочь вам с вопросами о нашем приложении для учета финансов.',
    keywords: 'контакты, поддержка, свяжитесь с нами, помощь, обслуживание клиентов'
  }
};
