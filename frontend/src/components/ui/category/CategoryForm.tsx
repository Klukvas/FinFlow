...
export const CategoryForm = React.memo<CategoryFormProps>(
 ...
 className={`w-full px-3 sm:px-4 py-3 bg-elevated border rounded-lg sm:rounded-xl text-content placeholder:text-content-tertiary focus:ring-2 focus:ring-[var(--color-ring)] focus:border-transparent transition-colors shadow-sm hover:shadow-md focus:shadow-lg text-sm sm:text-base min-h-[44px] ${
 fieldErrors.name ? "border-danger-base" : "border-[var(--color-border)]"
 }`}
 />
 {fieldErrors.name && (
 <p
 ...
 onChange={handleChange}
 disabled={mode === "edit"}
 className={`w-full px-3 sm:px-4 py-3 bg-elevated border border-[var(--color-border)] rounded-lg sm:rounded-xl text-content focus:ring-2 focus:ring-[var(--color-ring)] focus:border-transparent transition-colors shadow-sm hover:shadow-md focus:shadow-lg text-sm sm:text-base min-h-[44px] ${
 ...
 {error && (
 <div
 className="bg-[var(--color-danger-light)] border border-[var(--color-border)] rounded-lg sm:rounded-xl p-3 sm:p-4"
 ...
 type="button"
 onClick={onCancel}
 className="flex-1 bg-elevated hover:bg-surface-alt text-content font-semibold py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl transition-colors flex items-center justify-center gap-2 sm:gap-3 border border-[var(--color-border)] hover:shadow-md min-h-[44px] text-sm sm:text-base"
 >
 <svg
