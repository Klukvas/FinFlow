...
export const CategoryList: React.FC<CategoryListProps> = ({
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div
                        ...
                        className="text-sm font-mono theme-text-secondary"
                      >
                        #{category.id}
                      </div>
                    </td>
  ...
  const renderEmpty = (totalItems: number) => (
    <div className="text-center py-8 sm:py-12 lg:py-16">
      <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mx-auto mb-4 sm:mb-6 theme-bg-tertiary rounded-xl sm:rounded-2xl flex items-center justify-center">
        <svg
          className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 theme-text-tertiary"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <div className="theme-bg-secondary px-4 sm:px-6 py-3 sm:py-4 lg:px-8 lg:py-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold theme-text-primary">
              {t("category.title")}
            </h2>
          </div>
