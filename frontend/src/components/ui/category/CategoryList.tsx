...
export const CategoryList: React.FC<CategoryListProps> = ({
 ...
 <div
 key={category.id}
 className="bg-surface-alt rounded-lg sm:rounded-xl border border-[var(--color-border)] p-3 sm:p-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 cursor-pointer"
