...
export const CategorySidePanel: React.FC<CategorySidePanelProps> = ({
  ...
  if (category.mcc_code) {
    overviewRows.push({
      ...
      valueClass: "text-content font-mono",
    });
  }
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed inset-y-0 right-0 z-40 w-full sm:w-[480px] lg:w-[40%] max-w-[560px] bg-elevated border-l border-[var(--border)] shadow-2xl transform transition-transform duration-300 flex flex-col ${
      ...
      >
            ...
            {usageLoading ? (
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm tabular-nums text-danger-base/80">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm tabular-nums text-success-base/80">
                ...
                {usageData.totalAmount > 0 && (
                  <>
                    <div className="flex items-center justify-between pt-2 border-t border-[var(--border)]">
                      ...
                      <span className="text-sm font-mono font-semibold text-content tabular-nums">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-mono text-content tabular-nums">
              ...
              <div className="p-4 sm:p-6 space-y-3">
                ...
                <div className="space-y-2">
                  {childCategories.map((child) => (
                    <button
                      key={child.id}
                      className="w-full flex items-center justify-between p-2 rounded-lg hover:bg-surface-alt transition-colors text-left"
                      onClick={() => onChildClick(child)}
                    >
                      <span className="text-sm text-content">{child.name}</span>
                      <Badge
                  ...
                  <tbody className="divide-y border-[var(--border)]">
                    {recentTransactions.map((tx) => (
                      <tr key={tx.id}>
                        ...
                        <td
                          className={`px-3 py-2 text-sm font-mono font-medium tabular-nums text-right ${
                            tx.type === "income"
                        ...
                        <td className="px-3 py-2 text-sm text-content-secondary truncate max-w-[120px]">
                          {tx.description || "\u2014"}
                        </td>
                      </tr>
                    ))}
        ...
        <div className="border-t border-[var(--border)] p-4 sm:p-6 flex-shrink-0">
