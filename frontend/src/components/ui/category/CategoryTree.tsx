...
export const CategoryTree: React.FC<CategoryTreeProps> = ({
 ...
 {hasChildren ? (
 <button
 className="p-0.5 rounded hover:bg-surface-alt transition-colors flex-shrink-0"
 onClick={(e) => {
 e.stopPropagation();
 ...
 >
 <svg
 className={`w-4 h-4 text-content-secondary transition-transform duration-150 ${isExpanded ? "rotate-90" : ""}`}
 fill="none"
 stroke="currentColor"
 viewBox="0 0 24 24"
 >
 ...
 {depth > 0 && (
 <span className="w-2 h-px bg-surface-alt flex-shrink-0" />
 )}
 <span
