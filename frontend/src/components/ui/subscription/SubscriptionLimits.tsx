...
export const SubscriptionLimits: React.FC<SubscriptionLimitsProps> = ({
 ...
 <FaTimesCircle className="w-8 h-8 text-danger-base mx-auto mb-2" />
 ...
 <div className="mb-4 p-4 rounded-lg bg-[var(--color-warning-light)] border-2 border-warning-base flex items-start gap-3">
 ...
 {/* Paused Info Banner */}
 {isPaused && (
 <div className="mb-4 p-4 rounded-lg bg-surface-alt border-2 border-[var(--color-border)] flex items-start gap-3">
 <FaBan className="w-5 h-5 text-content-tertiary flex-shrink-0 mt-0.5" />
 <div className="flex-1">
 <p className="font-semibold text-content mb-1">
 ...
 feature.enabled
 ? "bg-elevated border-[var(--color-border)]"
 : "bg-surface-alt border-[var(--color-border)] opacity-60"
 }`}
 >
 ...
 <div
 className={
 feature.enabled ? "text-accent-base" : "text-content-tertiary"
 }
 >
 {icon}
 </div>
 ...
 {features.length === 0 && (
 <div className="text-center py-8">
 <FaCrown className="w-8 h-8 text-content-tertiary mx-auto mb-2" />
