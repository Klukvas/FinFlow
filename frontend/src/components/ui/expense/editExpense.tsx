...
export const EditExpense: React.FC<EditExpenseProps> = ({
  ...
  const { activeAccounts: accounts, isLoading: isLoadingAccounts } =
    useAccounts();
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        <div className="space-y-4 sm:space-y-6">
          ...
          <FormattedNumberInput
            ...
            required
            error={
              amountTouched && (!formData.amount || formData.amount <= 0)
          ...
          <div className="space-y-2">
            ...
            >
              ...
              {isLoadingAccounts ? (
                <option>{t("expense.loadingAccounts")}</option>
              ) : accounts.length === 0 ? (
          ...
          {error && (
            <div
              className="theme-error-light theme-border border rounded-lg sm:rounded-xl p-3 sm:p-4"
