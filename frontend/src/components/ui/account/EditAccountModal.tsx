...
export const EditAccountModal: React.FC<EditAccountModalProps> = ({
 ...
 className="w-full px-3 py-2 border-[var(--color-border)] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-ring)] focus:border-transparent transition-colors bg-surface text-content"
 >
