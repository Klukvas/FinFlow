            ...
            <div className="space-y-3">
              {overviewRows.map((row) => (
                ...
                >
                  ...
                  <span
                    className={`text-sm font-mono tabular-nums ${row.valueClass}`}
                  >
                    {row.value}
                  </span>
                </div>
              ...
              <div className="p-4 sm:p-6 space-y-3">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-mono font-semibold tabular-nums text-success-base/80">
                      +
                      {formatBalance(
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-mono font-semibold tabular-nums text-danger-base/80">
                      -
                      {formatBalance(
