...
export const ConnectForm: React.FC<ConnectFormProps> = ({
  ...
  return (
    <div className="max-w-xl mx-auto">
      <div className="bg-elevated rounded-lg p-6 shadow-sm border-[var(--border)] border">
        <div className="text-center mb-6">
          <div className="w-16 h-16 bg-[var(--accent-dim)] rounded-full flex items-center justify-center mx-auto mb-4">
            <Link2 className="w-8 h-8 text-accent-base" />
          </div>
        ...
        <div className="bg-surface rounded-lg p-4 mb-6">
          ...
          >
            api.monobank.ua <ExternalLink className="w-3 h-3" />
          </a>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-surface border-[var(--border)] border rounded-lg text-content text-sm focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
              disabled={isLoading}
              autoComplete="off"
            />
          </div>
