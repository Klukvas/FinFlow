...
export const SyncTransactionReview: React.FC<SyncTransactionReviewProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 overflow-y-auto p-2 sm:p-4">
      <div className="theme-surface rounded-xl theme-shadow-hover w-full max-w-6xl max-h-[95vh] overflow-hidden flex flex-col mx-auto">
        {/* Header */}
        <div className="flex justify-between items-center p-4 sm:p-6 theme-border border-b theme-bg-secondary">
          ...
          <button
            ...
            className="theme-text-tertiary hover:theme-text-primary rounded-full p-2 theme-transition flex-shrink-0"
          >
            <svg
        ...
        {isLoading ? (
          ...
          <>
            ...
            {/* Footer skeleton */}
            <div className="flex justify-between items-center p-4 sm:p-6 theme-border border-t theme-bg-secondary">
          ...
          <>
            ...
            <div className="p-4 sm:p-6 theme-bg-secondary theme-border border-b">
              ...
              {(expenseLimit !== null || incomeLimit !== null) && (
                <div className="flex flex-wrap gap-4 mt-3 pt-3 border-t theme-border">
                  {expenseLimit !== null && (
                    <span className="text-xs theme-text-secondary">
                      {t("bankSync.review.expenseQuota", {
                        count: expenseCount,
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-4 sm:p-6 space-y-3">
                {editableTransactions.map((txn, index) => (
                  <div
                    key={txn.external_id}
                    className={`theme-border border rounded-lg p-4 theme-transition ${
                      txn.included
                        ? "theme-surface"
                        : "opacity-50 theme-bg-secondary"
                    }`}
                  >
                    <div className="flex items-start gap-3">
                      {/* Checkbox */}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-2 py-1.5 text-sm theme-border border rounded-md theme-surface theme-text-primary disabled:opacity-50"
                            />
                          </div>
                          ...
                          <div>
                            <label className="block text-xs font-medium theme-text-secondary mb-1">
                              ...
                              {txn.category_name && !txn.category_id && (
                                <span className="ml-1 text-xs theme-text-tertiary">
            ...
            <div className="flex justify-between items-center p-4 sm:p-6 theme-border border-t theme-bg-secondary">
              ...
              <div className="flex gap-3">
                <button
                  onClick={onClose}
                  disabled={isConfirming}
                  className="px-4 py-2 theme-border border theme-text-primary rounded-lg hover:theme-surface-hover theme-transition font-medium text-sm"
                >
                ...
                <button
                  ...
                  className="px-6 py-2 rounded-lg font-medium text-sm text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed theme-transition flex items-center gap-2"
                >
                  {isConfirming && (
                    <svg
