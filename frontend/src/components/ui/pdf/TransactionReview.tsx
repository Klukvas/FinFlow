      ...
      <div className="theme-surface rounded-xl theme-shadow-hover w-full max-w-7xl max-h-[95vh] overflow-hidden flex flex-col theme-transition mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 sm:p-6 theme-border border-b theme-bg-secondary">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm theme-text-secondary mt-1 hidden sm:block">
              Review and edit the transactions before creating them
            </p>
            <p className="text-xs theme-text-secondary mt-1 sm:hidden">
          ...
          <div className="mx-4 sm:mx-6 mt-4 p-3 sm:p-4 theme-error-light border-l-4 theme-error-bg rounded-r-lg">
            <div className="flex">
              <div className="flex-shrink-0">
                <svg
                  className="h-4 w-4 sm:h-5 sm:w-5 theme-error"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
        ...
        {limitInfo && (
          <div className="mx-4 sm:mx-6 mt-4 p-3 sm:p-4 theme-bg-secondary theme-border border rounded-lg">
            <div className="flex items-start">
              <div className="flex-shrink-0">
                <svg
                  className="h-4 w-4 sm:h-5 sm:w-5 theme-accent"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
              ...
              <div className="ml-3 flex-1">
                <h3 className="text-xs sm:text-sm font-semibold theme-text-primary mb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs sm:text-sm font-medium theme-text-primary uppercase">
                      {limitInfo.plan_code}
                    </span>
                  </div>
                  <div className="flex flex-col">
        ...
        {validationWarnings.length > 0 && (
          <div className="mx-4 sm:mx-6 mt-4 space-y-2">
            <div className="flex items-center space-x-2 mb-2">
              <svg
                className="h-4 w-4 sm:h-5 sm:w-5 theme-warning"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
              ...
              <h3 className="text-xs sm:text-sm font-semibold theme-warning">
                Validation Issues
              </h3>
            </div>
            {validationWarnings.map((warning, idx) => (
              <div
                key={idx}
                className="p-3 sm:p-4 theme-warning-light border-l-4 theme-warning-bg rounded-r-lg"
              >
                <div className="flex">
                  <div className="flex-shrink-0">
                    <svg
                  ...
                  <div className="ml-3">
                    <p className="text-xs sm:text-sm theme-text-primary">
                      {warning}
                    </p>
                  </div>
                </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs sm:text-sm font-medium theme-error">
              ...
              (() => {
                ...
                return (
                  <div className="flex flex-col space-y-2 pt-3 border-t theme-border">
                    <div className="text-xs sm:text-sm font-semibold theme-text-secondary mb-1">
                    ...
                    <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                      <div className="flex items-center space-x-2">
                        <div
                          className={`w-2 h-2 rounded-full ${validation.stage1Pass ? "bg-green-500" : "bg-red-500"}`}
                        ></div>
                        <span className="text-xs theme-text-secondary">
                          <strong>
                    ...
                    {limitInfo?.records_per_upload !== null &&
                      limitInfo?.records_per_upload !== undefined && (
                        <div className="flex items-center space-x-2">
                          <div
                            className={`w-2 h-2 rounded-full ${validation.stage2Pass ? "bg-green-500" : "bg-red-500"}`}
                          ></div>
                          <span className="text-xs theme-text-secondary">
                            <strong>
                    ...
                    {/* Overall Status */}
                    <div
                      className={`text-xs sm:text-sm font-medium ${validation.canProceed ? "theme-success" : "theme-error"}`}
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <span className="theme-text-tertiary text-xs sm:text-sm">
                              $
                            </span>
                          </div>
                          <input
                    ...
                    {transaction.is_valid &&
                      getValidationErrors(transaction).length > 0 && (
                        <div className="mt-4 p-3 theme-error-light theme-border border rounded-lg">
                          <div className="flex">
                            <svg
                              className="w-4 h-4 theme-error mt-0.5 mr-2"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path
