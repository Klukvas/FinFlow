    ...
    <div className="p-5 rounded-xl theme-surface border theme-border shadow-sm hover:shadow-md theme-transition">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-lg theme-accent-light theme-accent">
      ...
      {/* Inviter info */}
      <div className="p-3 rounded-lg theme-bg-secondary mb-4">
      ...
      {canRespond ? (
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border theme-border theme-text-secondary hover:theme-surface-hover hover:text-red-600 font-medium theme-transition disabled:opacity-50"
            disabled={isLoading}
          >
        ...
        <div className="text-center py-2 rounded-lg theme-bg-secondary text-sm theme-text-tertiary">
          {isExpired
            ? t(
