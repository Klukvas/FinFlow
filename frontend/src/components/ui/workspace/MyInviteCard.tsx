...
export const MyInviteCard: React.FC<MyInviteCardProps> = ({
 ...
 return (
 <div className="p-5 rounded-xl bg-elevated border border-[var(--color-border)] shadow-sm hover:shadow-md transition-colors">
 {/* Header - Workspace Info */}
 <div className="flex items-start justify-between mb-4">
 <div className="flex items-center gap-3">
 <div className="p-2.5 rounded-lg bg-[var(--color-accent-light)] text-accent-base">
 ...
 className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-[var(--color-border)] text-content-secondary hover:bg-surface-alt hover:text-danger-base font-medium transition-colors disabled:opacity-50"
 disabled={isLoading}
 >
