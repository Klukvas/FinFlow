...
export const WorkspaceSelector: React.FC<WorkspaceSelectorProps> = ({
 ...
 className={`flex items-center gap-2 px-3 py-2 rounded-lg bg-surface-alt transition-colors hover:bg-[var(--color-accent-light)] ${
 compact ? "text-sm" : ""
 }`}
 >
 ...
 <FaUsers className="w-4 h-4 text-accent-base" />
 )}
 <span
 ...
 {isOpen && (
 <div className="absolute top-full left-0 mt-1 w-64 py-2 bg-elevated rounded-lg shadow-lg border-[var(--color-border)] border z-50">
