...
export const WorkspaceForm: React.FC<WorkspaceFormProps> = ({
 ...
 className="w-full px-4 py-3 rounded-lg bg-elevated border-[var(--color-border)] border text-content placeholder:text-content-tertiary focus:ring-2 focus:ring-[var(--color-ring)] focus:border-transparent transition-colors"
 disabled={isLoading}
 autoFocus
 />
 </div>
