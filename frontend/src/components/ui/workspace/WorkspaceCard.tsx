...
export const WorkspaceCard: React.FC<WorkspaceCardProps> = ({
 ...
 return (
 <div
 className={`relative p-4 rounded-xl bg-elevated border-[var(--color-border)] border transition-colors hover:shadow-md ${
 isCurrentWorkspace
 ...
 className="flex-1 px-3 py-2 text-sm font-medium text-accent-base bg-[var(--color-accent-light)] rounded-lg hover:opacity-80 transition-colors"
 >
