 ...
 *
 ...
 className={`block w-full pl-8 pr-3 py-3 text-base border-[var(--color-border)] border rounded-lg shadow-sm bg-surface text-content placeholder:text-content-tertiary focus:outline-none focus:ring-2 focus:ring-[var(--color-ring)] focus:border-transparent transition-colors ${
 error
