...
export const GoalCard: React.FC<GoalCardProps> = ({
  ...
  return (
    <div className="bg-elevated theme-shadow rounded-lg border border-[var(--border)] p-4 sm:p-6 hover:theme-shadow-hover transition-colors">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
        <div className="flex items-center gap-2">
          <DollarSign className="w-4 h-4 text-content-tertiary flex-shrink-0" />
          <div className="min-w-0 flex-1">
            <p className="text-xs text-content-tertiary">
              {t("goalsPage.progressModal.currentAmount")}
            </p>
            <p className="text-sm font-mono font-semibold text-content truncate">
              {goal.current_amount.toLocaleString()} {goal.currency}
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Target className="w-4 h-4 text-content-tertiary flex-shrink-0" />
          <div className="min-w-0 flex-1">
            <p className="text-xs text-content-tertiary">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        {goal.is_milestone_based && (
          <button className="px-4 py-3 sm:py-2 border border-[var(--border)] text-content-secondary rounded-md hover:bg-surface-alt transition-colors text-sm font-medium min-h-[44px] touch-manipulation">
