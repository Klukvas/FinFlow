...
export const GoalTable: React.FC<GoalTableProps> = ({
  ...
  const SortIcon = ({ field }: { field: SortField }) => (
    <svg
      className={`w-3 h-3 ml-1 inline-block ${sortField === field ? "text-content" : "text-content-tertiary"}`}
      viewBox="0 0 12 12"
      fill="currentColor"
    >
  ...
  return (
    <div data-testid="goal-table">
      {/* Sort controls */}
      <div className="px-4 sm:px-6 py-3 border-b border-[var(--border)] flex items-center gap-4 text-xs font-medium text-content-secondary">
        <button
        ...
        {sortedGoals.map((goal) => {
          ...
          return (
            <div
              ...
              className="px-4 sm:px-6 py-4 cursor-pointer hover:bg-surface-alt transition-colors group"
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3 mb-2">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      data-testid={`goal-update-progress-${goal.id}`}
                      onClick={(e) => {
                        e.stopPropagation();
                        onUpdateProgress(goal);
                      }}
                      className="p-2 sm:p-1.5 rounded-md hover:bg-surface-alt transition-colors text-content-tertiary hover:text-content min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 flex items-center justify-center touch-manipulation"
                    ...
                    <button
                      ...
                      className="p-2 sm:p-1.5 rounded-md hover:bg-surface-alt transition-colors text-danger-base/60 hover:text-danger-base min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 flex items-center justify-center touch-manipulation"
              ...
              {/* Thin progress bar */}
              <div className="w-full h-1.5 rounded-full bg-surface-alt overflow-hidden mb-3">
                <div
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-4 gap-y-1.5 text-xs">
                <div className="min-w-0">
                  <span className="text-content-tertiary block sm:inline">
                    {t("goalsPage.table.info.currentAmount")}
                  </span>
                  <span className="sm:ml-1 font-mono font-medium text-success-base/80 tabular-nums block sm:inline truncate">
                ...
                <div className="min-w-0">
                  ...
                  <span className="sm:ml-1 font-mono font-medium text-content tabular-nums block sm:inline truncate">
                ...
                <div className="hidden sm:block min-w-0">
                  ...
                  <span className="ml-1 font-mono font-medium text-content tabular-nums">
                ...
                <div className="hidden sm:block min-w-0">
                  ...
                  <span className="ml-1 font-medium text-content">
                ...
                <div className="min-w-0">
                  ...
                  <span
                    className={`sm:ml-1 font-medium tabular-nums block sm:inline ${isOverdue ? "text-danger-base/80" : "text-content"}`}
                  >
                    {daysRemaining !== null
                      ? isOverdue
