...
export const GoalTable: React.FC<GoalTableProps> = ({
 ...
 <div>
 {/* Sort controls */}
 <div className="px-4 sm:px-6 py-3 border-b border-[var(--color-border)] flex items-center gap-4 text-xs font-medium text-content-secondary">
 <button
 ...
 {/* Goal rows */}
 <div className="divide-y border-[var(--color-border)]">
 ...
 className="p-1.5 rounded-md hover:bg-surface-alt transition-colors text-content-tertiary hover:text-content"
 ...
 className="p-1.5 rounded-md hover:bg-surface-alt transition-colors text-danger-base/60 hover:text-danger-base"
 ...
 <span className="ml-1 font-medium text-success-base/80 tabular-nums">
 ...
 <span className="ml-1 font-medium text-content tabular-nums">
 ...
 <span
 className={`ml-1 font-medium tabular-nums ${isOverdue ? "text-danger-base/80" : "text-content"}`}
 >
 {daysRemaining !== null
 ? isOverdue
