...
export const GoalPageHeader: React.FC<GoalPageHeaderProps> = ({
  onAdd,
  onToggleFilters,
  onExportCsv,
  filtersActive,
  ...
  return (
    <div
      data-testid="goal-page-header"
      className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4"
    >
      <div className="flex items-center gap-3">
        <div>
          <h1
            data-testid="goal-page-title"
      ...
      <div className="flex items-center gap-2">
        <Button
          ...
          className={
            filtersActive ? "bg-[var(--accent-dim)] text-accent-base" : ""
          }
        >
          <svg
