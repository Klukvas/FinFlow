            ...
            <div className="space-y-3">
              {overviewRows.map((row) => (
                ...
                >
                  ...
                  <span
                    className={`text-sm font-mono tabular-nums flex items-center gap-1.5 ${row.valueClass}`}
                  >
                    {"dot" in row && row.dot && (
                      ...
                      <tbody className="divide-y border-[var(--border)]">
                        {milestones.map((milestone) => (
                          <tr key={milestone.id}>
                            ...
                            <td className="px-3 py-2 text-sm font-mono text-content-secondary tabular-nums text-right">
                              {formatAmount(
                                milestone.target_amount,
                                goal.currency,
                              )}
                            </td>
                            <td className="px-3 py-2 text-sm font-mono tabular-nums text-right text-success-base/80">
                              {formatAmount(
          ...
          <div className="p-4 sm:p-6 space-y-3">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-mono font-medium text-content tabular-nums">
                  {requiredMonthly !== null
                    ? formatAmount(requiredMonthly, goal.currency)
                    : "\u2014"}
                </span>
