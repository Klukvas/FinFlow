...
export const GoalForm: React.FC<GoalFormProps> = ({
 ...
 {/* Title */}
 <div>
 <label htmlFor="title" className="block text-sm font-medium text-content mb-1 sm:mb-2">
 ...
 className={`w-full px-3 py-3 sm:py-2 text-base sm:text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-accent transition-colors touch-manipulation bg-surface text-content ${
 errors.title ? 'bg-[var(--color-danger-light)] border-[var(--color-border)]' : 'border-[var(--color-border)]'
 }`}
 placeholder={t('goalsPage.form.titlePlaceholder')}
 />
 {errors.title && <p className="mt-1 text-sm text-danger-base">{errors.title}</p>}
 </div>

 {/* Description */}
 <div>
 <label htmlFor="description" className="block text-sm font-medium text-content mb-1 sm:mb-2">
 ...
 rows={3}
 className="w-full px-3 py-3 sm:py-2 text-base sm:text-sm border-[var(--color-border)] border rounded-md focus:outline-none focus:ring-2 focus:ring-accent transition-colors touch-manipulation bg-surface text-content"
 ...
 <div>
 <label htmlFor="goal_type" className="block text-sm font-medium text-content mb-1 sm:mb-2">
 ...
 <div>
 <label htmlFor="priority" className="block text-sm font-medium text-content mb-1 sm:mb-2">
 ...
 {/* Target Date */}
 <div>
 <label htmlFor="target_date" className="block text-sm font-medium text-content mb-1 sm:mb-2">
 ...
 className={`w-full px-3 py-3 sm:py-2 text-base sm:text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-accent transition-colors touch-manipulation bg-surface text-content ${
 errors.target_date ? 'bg-[var(--color-danger-light)] border-[var(--color-border)]' : 'border-[var(--color-border)]'
 }`}
 />
 {errors.target_date && <p className="mt-1 text-sm text-danger-base">{errors.target_date}</p>}
 </div>
 ...
 className="h-5 w-5 mt-0.5 sm:mt-0 text-accent-base focus:ring-accent border-[var(--color-border)] border rounded touch-manipulation"
 />
 <label htmlFor="is_milestone_based" className="block text-sm text-content leading-relaxed">
