...
export const GoalProgressModal: React.FC<GoalProgressModalProps> = ({
 ...
 <div>
 <span className="text-content-secondary">{t('goalsPage.progressModal.currentAmount')}:</span>
 <p className="font-medium text-content">{goal.current_amount.toLocaleString()} {goal.currency}</p>
 </div>
 <div>
 <span className="text-content-secondary">{t('goalsPage.progressModal.targetAmount')}:</span>
 <p className="font-medium text-content">{goal.target_amount.toLocaleString()} {goal.currency}</p>
 </div>
 </div>
 </div>
 ...
 <div>
 <label htmlFor="current_amount" className="block text-sm font-medium text-content mb-2">
 {t('goalsPage.progressModal.newCurrentAmount')}
 </label>
 <div className="relative">
 <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
 <FaDollarSign className="h-5 w-5 text-content-tertiary" />
 </div>
 <input
 type="number"
 id="current_amount"
 ...
 error ? 'bg-[var(--color-danger-light)] border-[var(--color-border)]' : 'border-[var(--color-border)]'
 }`}
 placeholder="0.00"
 />
 </div>
 ...
 <span className="text-sm font-medium text-content">{t('goalsPage.progressModal.newProgress')}</span>
