...
export const PublicHeader: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile Header */}
      <header
        className="theme-surface theme-border border-b theme-transition lg:hidden"
      ...
      {/* Desktop Header */}
      <header
        className="theme-surface theme-border border-b theme-transition hidden lg:block"
      ...
      {/* Mobile Menu */}
      <div
        className={`mobile-menu theme-surface theme-shadow ${mobileMenuOpen ? "open" : ""}`}
      ...
      >
        ...
        <div
          className="p-4 theme-border border-t space-y-2"
