...
export const DesktopHeader = React.memo(() => {
  ...
  const navigationItems = useMemo(
    () => [
      { path: "/category", icon: Folder, label: t("navigation.categories") },
      { path: "/expense", icon: Home, label: t("navigation.expenses") },
      { path: "/income", icon: DollarSign, label: t("navigation.income") },
      { path: "/recurring", icon: RefreshCw, label: t("navigation.recurring") },
    ],
    [t],
  );
  ...
  return (
    <header
      className="bg-elevated border-[var(--border)] border-b theme-shadow transition-colors"
      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            >
              <div className="w-8 h-8 bg-[var(--accent-dim)] rounded-full flex items-center justify-center group-hover:bg-accent-base-hover transition-colors">
            ...
            <button
              ...
              className="flex items-center px-3 py-2 text-sm text-danger-base hover:bg-[var(--danger-dim)] rounded-lg transition-colors"
