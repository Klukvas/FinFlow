...
export const PublicFooter: React.FC = () => {
  ...
  const socialLinks = [
    { icon: Mail, href: "mailto:finflow@flux-lab.dev", label: "Email" },
  ];

  return (
    <footer className="bg-elevated border-[var(--border)] border-t transition-colors">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        {/* Bottom Section */}
        <div className="mt-10 pt-6 border-[var(--border)] border-t">
