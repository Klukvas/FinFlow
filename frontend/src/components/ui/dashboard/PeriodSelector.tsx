...
export const PeriodSelector: React.FC<PeriodSelectorProps> = ({
 ...
 : isAllowed
 ? "bg-elevated text-content-secondary hover:text-content border-[var(--color-border)] border"
 : "bg-elevated text-content-tertiary cursor-not-allowed opacity-60 border-[var(--color-border)] border"
 }
 `}
 >
