    ...
    return (
      <div className="bg-elevated rounded-lg theme-shadow border-[var(--border)] border p-6">
        <div className="text-center">
          <Target className="mx-auto h-12 w-12 text-content-tertiary mb-4" />
    ...
    <div className="bg-elevated rounded-lg theme-shadow border-[var(--border)] border p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          <Target className="h-6 w-6 text-accent-base mr-2" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="text-center">
          <div className="flex items-center justify-center mb-2">
            <Target className="h-5 w-5 text-accent-base" />
          </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center mb-2">
            <Play className="h-5 w-5 text-success-base" />
          </div>
          <p className="text-2xl font-bold text-content">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center mb-2">
            <CheckCircle2 className="h-5 w-5 text-accent-base" />
          </div>
          <p className="text-2xl font-bold text-content">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center mb-2">
            <PieChart className="h-5 w-5 text-accent-base" />
          </div>
          <p className="text-2xl font-bold text-content">
      ...
      <div className="bg-surface-alt rounded-lg p-4 mb-6">
        <div className="flex items-center mb-3">
          <DollarSign className="h-5 w-5 text-success-base mr-2" />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-lg font-mono font-bold text-success-base">
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="text-sm font-mono font-medium text-content">
