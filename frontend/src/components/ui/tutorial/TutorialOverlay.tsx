...
export const TutorialOverlay: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999]" role="dialog" aria-modal="true">
      ...
      {targetRect && (
        <div
          className="absolute border-2 border-blue-400 rounded-xl transition-all duration-300 ease-out animate-pulse"
          style={{
            top: targetRect.top - 8,
            left: targetRect.left - 8,
            width: targetRect.width + 16,
      ...
      >
        ...
        <div className="px-5 py-3 bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-b border-slate-700/50">
