...
export const AiSubscriptionGate: React.FC = () => {
 ...
 <FaLock className="w-8 h-8 text-content-tertiary" />
 </div>
 <h2 className="text-xl font-semibold text-content mb-2">
 {t("aiAssistant.locked.title")}
 </h2>
 <p className="text-content-secondary text-sm max-w-md mb-6">
 {t("aiAssistant.locked.description")}
 </p>
 <Link
 to="/pricing"
 className="px-6 py-2.5 rounded-lg bg-accent-base text-content-inverse font-medium text-sm hover:opacity-90 transition-colors"
 >
