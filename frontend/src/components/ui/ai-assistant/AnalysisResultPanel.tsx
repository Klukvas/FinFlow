...
export const AnalysisResultPanel: React.FC<AnalysisResultPanelProps> = ({
 ...
 if (isLoading) {
 return (
 <div className="mt-6 p-8 rounded-lg bg-elevated border-[var(--color-border)] border text-center">
 <FaSpinner className="w-8 h-8 text-accent-base animate-spin mx-auto mb-3" />
 ...
 if (error) {
 return (
 <div className="mt-6 p-6 rounded-lg bg-[var(--color-danger-light)] border border-[var(--color-border)]">
 ...
 <FaCheckCircle className="w-4 h-4 text-success-base" />
