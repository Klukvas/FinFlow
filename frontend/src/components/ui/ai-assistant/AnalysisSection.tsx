...
const PRIORITY_STYLES: Record<string, string> = {
  high: "theme-error-light theme-error",
  medium: "theme-warning-light theme-warning",
  low: "theme-success-light theme-success",
};
...
export const AnalysisSectionCard: React.FC<AnalysisSectionProps> = ({
  ...
  return (
    <div className="p-4 rounded-lg theme-border border">
      ...
      <div
        className="text-sm theme-text-secondary prose prose-sm max-w-none
          [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5
          [&_li]:mb-1 [&_p]:mb-2 [&_strong]:theme-text-primary"
