...
export const TopIncomeChart: React.FC<TopIncomeChartProps> = ({ incomes, categories }) => {
 ...
 <XAxis type="number" tick={{ fill: 'var(--color-text)', fontSize: 12 }} axisLine={{ stroke: 'var(--color-border)' }} />
 <YAxis dataKey="name" type="category" width={100} tick={{ fill: 'var(--color-text)', fontSize: 12 }} axisLine={{ stroke: 'var(--color-border)' }} />
