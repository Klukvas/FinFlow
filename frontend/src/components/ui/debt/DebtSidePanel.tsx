        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-4 sm:p-6 space-y-3">
            ...
            {paymentsLoading ? (
              ...
              <div className="space-y-0 rounded-lg border border-[var(--border)] overflow-x-auto">
                  ...
                  <tbody className="divide-y border-[var(--border)]">
                    {payments.map((p) => (
                      <tr key={p.id}>
                        ...
                        <td className="px-3 py-2 text-sm text-right text-success-base/80 font-mono font-medium tabular-nums">
                          +
