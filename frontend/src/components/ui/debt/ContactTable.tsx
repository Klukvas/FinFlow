...
export const ContactTable: React.FC<ContactTableProps> = ({
 ...
 className="text-xs text-accent-base hover:underline mt-0.5 block"
 >
 {contact.email}
 </a>
 )}
 ...
 <span className="text-xs text-danger-base/80 tabular-nums">
 ...
 <td className="px-4 py-3 text-right">
 <span className="text-sm text-danger-base/80 tabular-nums">
 {contact.total_debt_amount > 0
 ? formatCurrency(
