...
export const DebtCard: React.FC<DebtCardProps> = ({
 ...
 return (
 <Card className="transition-all duration-200 hover:shadow-lg bg-elevated border-[var(--color-border)] border hover:border-[var(--color-border)]">
 ...
 debt.current_balance >= 0 ? "text-success-base" : "text-danger-base"
 }`}
 >
 ...
 <div className="w-full rounded-full h-2 border-[var(--color-border)] bg-surface-alt">
 <div
 className="bg-gradient-to-r from-success-base to-accent-base h-2 rounded-full transition-all duration-300"
 ...
 debt.current_balance >= 0
 ? "bg-[var(--color-success-light)] border-[var(--color-border)]"
 : "bg-[var(--color-danger-light)] border-[var(--color-border)]"
 }`}
 >
