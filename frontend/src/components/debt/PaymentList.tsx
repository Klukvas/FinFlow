...
export const PaymentList: React.FC<PaymentListProps> = ({
 ...
 <Card
 key={index}
 className="animate-pulse bg-elevated border-[var(--color-border)] border"
 >
 ...
 <Card
 key={payment.id}
 className="transition-all duration-200 hover:shadow-md bg-elevated border-[var(--color-border)] border hover:border-[var(--color-border)]"
 >
 <CardContent className="p-4">
