  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* Warning */}
        <div className="flex items-start gap-3 p-4 rounded-lg bg-surface-warning border border-[var(--border)]-warning">
        ...
        <div className="bg-surface-alt p-4 rounded-lg border border-[var(--border)]">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div>
              ...
              <p className="font-medium text-content">{formattedExpiryDate}</p>
            </div>
            {subscription.amount && (
              <div>
                <p className="text-content-secondary">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full px-3 py-2 rounded-lg border border-[var(--border)] bg-surface text-content focus:ring-2 focus:ring-[var(--accent)]"
          >
            <option value="">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 rounded-lg border border-[var(--border)] bg-surface text-content focus:ring-2 focus:ring-[var(--accent)] resize-none"
          />
