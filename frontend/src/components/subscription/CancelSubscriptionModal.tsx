...
> = ({ isOpen, onClose, subscription, onCancelSuccess }) => {
 ...
 {/* Warning */}
 <div className="flex items-start gap-3 p-4 rounded-lg bg-surface-warning border border-[var(--color-border)]-warning">
 <FaExclamationTriangle className="w-5 h-5 text-warning-base flex-shrink-0 mt-0.5" />
 ...
 {/* Subscription Info */}
 <div className="bg-surface-alt p-4 rounded-lg border border-[var(--color-border)]">
 <h4 className="font-semibold text-content mb-3">
 ...
 <label className="flex items-start gap-3 p-4 rounded-lg border border-[var(--color-border)] cursor-pointer hover:bg-surface-alt transition-colors">
 <input
 type="radio"
 name="cancelType"
 ...
 className="w-full px-3 py-2 rounded-lg border border-[var(--color-border)] bg-surface text-content focus:ring-2 focus:ring-[var(--color-ring)]"
 >
 <option value="">
 ...
 className="w-full px-3 py-2 rounded-lg border border-[var(--color-border)] bg-surface text-content focus:ring-2 focus:ring-[var(--color-ring)] resize-none"
 />
 <p className="text-xs text-content-secondary text-right">
 {comment.length}/500
 </p>
 </div>
 ...
 fullWidth
 disabled={isSubmitting}
 className="bg-danger-base hover:bg-danger-base-hover text-white"
 >
 {isSubmitting ? (
 <>
