...
export const UpgradePlanModal: React.FC<UpgradePlanModalProps> = ({
 ...
 <FaSpinner className="animate-spin text-4xl text-content-secondary" />
 </div>
 ) : error ? (
 ...
 <div
 key={plan.code}
 className={`relative bg-elevated border-[var(--color-border)] border rounded-xl p-6 transition-all ${
 isCurrentPlan
 ? "ring-2 ring-[var(--color-success)]"
 : pricing.popular
 ? "ring-2 ring-[var(--color-ring)] scale-[1.02]"
 : ""
 ...
 <span className="bg-gradient-to-r from-success-base to-teal-500 text-white px-4 py-1 rounded-full text-xs font-medium shadow-lg">
 {t("subscription.currentPlan", "Current Plan")}
 </span>
 </div>
 ) : pricing.popular ? (
 <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
 <span className="bg-gradient-to-r from-accent-base to-purple-500 text-white px-4 py-1 rounded-full text-xs font-medium shadow-lg">
 ...
 >
 <FaCheck className="w-4 h-4 text-success-base mr-3 mt-0.5 flex-shrink-0" />
 ...
 <div className="flex items-center justify-center gap-4 p-4 rounded-lg bg-surface-alt border border-[var(--color-border)]">
