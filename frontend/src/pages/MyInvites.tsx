...
export const MyInvites: React.FC = () => {
 ...
 <div className="p-3 rounded-xl bg-[var(--color-accent-light)] text-accent-base">
 ...
 {/* Success message */}
 {successMessage && (
 <div className="mb-6 p-4 rounded-lg bg-[var(--color-success-light)] text-success-base flex items-center gap-3">
 ...
 <FaInbox className="w-10 h-10 text-content-tertiary" />
 </div>
