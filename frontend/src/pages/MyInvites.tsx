...
import { Mail, Loader2, Inbox, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-full">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-xl bg-[var(--accent-dim)] text-accent-base">
      ...
      {/* Success message */}
      {successMessage && (
        <div className="mb-6 p-4 rounded-lg bg-[var(--success-dim)] text-success-base flex items-center gap-3">
      ...
      {/* Error message */}
      {error && (
        <div className="mb-6 p-4 rounded-lg bg-[var(--danger-dim)] text-danger-base">
          {error}
        </div>
      )}
      ...
      {!isLoading && invites.length === 0 && (
        <div className="text-center py-16">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-surface-alt mb-4">
            <Inbox className="w-10 h-10 text-content-tertiary" />
          </div>
