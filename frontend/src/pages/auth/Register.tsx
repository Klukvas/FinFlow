...
import { validatePasswordStrength, validateEmail, validateEmailDomain } from '../../utils/validation';
...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!emailResult.isValid || !emailDomainResult.isValid || !passwordResult.isValid || currencyError) {
      return;
    }
