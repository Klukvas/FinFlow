...
const BankSync: React.FC = () => {
 ...
 {error && (
 <div className="mb-4 p-3 rounded-lg bg-[var(--color-danger-light)] border border-[var(--color-danger-light)] flex items-center gap-2">
 <FaExclamationTriangle className="text-danger-base w-4 h-4 flex-shrink-0" />
 <p className="text-sm text-danger-base">{error}</p>
 </div>
 )}

 {successMsg && (
 <div className="mb-4 p-3 rounded-lg bg-[var(--color-success-light)] border border-[var(--color-success-light)] flex items-center gap-2">
 <FaCheckCircle className="text-success-base w-4 h-4 flex-shrink-0" />
 ...
 <div className="bg-elevated rounded-lg p-5 border-[var(--color-border)] border">
 ...
 disabled={isSyncing}
 className="px-3 py-2 md:py-2 min-h-[44px] rounded-lg text-sm bg-elevated border-[var(--color-border)] border text-content disabled:opacity-50"
 >
 {[7, 14, 30].map((d) => (
 ...
 className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-danger-base hover:bg-[var(--color-danger-light)] border-[var(--color-border)] border transition-colors"
 >
