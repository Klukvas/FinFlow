...
export const Home: React.FC = () => {
 ...
 <a
 href="/features"
 className="inline-flex items-center gap-2 px-8 py-3.5 text-base font-medium text-content-secondary hover:text-content transition-colors rounded-xl border border-[var(--color-border)] hover:border-[var(--color-border-hover)]"
 >
 ...
 <div className="rounded-2xl border border-[var(--color-border)] bg-elevated p-6 lg:p-8">
 <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
 {/* Workspace Switcher */}
 <div className="col-span-2 sm:col-span-3 lg:col-span-5 flex items-center gap-3 pb-4 border-b border-[var(--color-border)] mb-2">
 <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-surface-alt">
 <HiOutlineUserGroup className="w-4 h-4 text-content-secondary" />
 <span className="text-sm font-medium text-content">{t('homepage.hero.preview.workspace')}</span>
 </div>
 <span className="text-xs text-content-tertiary">/</span>
 <span className="text-sm text-content-secondary">{t('homepage.hero.preview.personal')}</span>
 </div>

 {/* Account Card */}
 <div className="rounded-xl bg-surface-alt p-4">
 <div className="text-xs text-content-tertiary mb-1">{t('homepage.hero.preview.accounts')}</div>
 <div className="text-lg font-semibold text-content">$12,450</div>
 <div className="text-xs text-content-secondary mt-1">3 {t('homepage.hero.preview.active')}</div>
 </div>

 {/* Expenses Card */}
 <div className="rounded-xl bg-surface-alt p-4">
 <div className="text-xs text-content-tertiary mb-1">{t('homepage.hero.preview.expenses')}</div>
 <div className="text-lg font-semibold text-content">$2,180</div>
 <div className="text-xs text-danger-base mt-1">-12%</div>
 </div>

 {/* Income Card */}
 <div className="rounded-xl bg-surface-alt p-4">
 <div className="text-xs text-content-tertiary mb-1">{t('homepage.hero.preview.income')}</div>
 <div className="text-lg font-semibold text-content">$5,400</div>
 <div className="text-xs text-success-base mt-1">+8%</div>
 </div>

 {/* Recurring Badge */}
 <div className="rounded-xl bg-surface-alt p-4">
 <div className="text-xs text-content-tertiary mb-1">{t('homepage.hero.preview.recurring')}</div>
 ...
 <span className="text-xs text-content-secondary">{t('homepage.hero.preview.automated')}</span>
 </div>
 </div>

 {/* Goal Progress */}
 <div className="rounded-xl bg-surface-alt p-4">
 <div className="text-xs text-content-tertiary mb-1">{t('homepage.hero.preview.goal')}</div>
 <div className="text-lg font-semibold text-content">68%</div>
 ...
 {/* Currency Indicator */}
 <div className="col-span-2 sm:col-span-3 lg:col-span-5 flex items-center gap-4 pt-3 border-t border-[var(--color-border)] mt-2">
 ...
 <div
 key={badge.labelKey}
 className="flex items-center gap-2.5 px-5 py-3 rounded-xl border border-[var(--color-border)] bg-elevated transition-colors"
 >
 ...
 <div
 key={item.titleKey}
 className="group rounded-xl border border-[var(--color-border)] bg-elevated p-6 hover:border-[var(--color-border-hover)] transition-colors"
 >
 ...
 {/* Workspace Visual */}
 <div className="rounded-2xl border border-[var(--color-border)] bg-elevated p-6">
 ...
 <HiOutlineLockClosed className="w-4 h-4 text-content-secondary" />
 </div>
 <div>
 <div className="text-sm font-medium text-content">{t('homepage.workspaces.visual.personal')}</div>
 <div className="text-xs text-content-tertiary">{t('homepage.workspaces.visual.personalRole')}</div>
 </div>
 </div>
 <span className="text-xs px-2 py-1 rounded-md bg-[var(--color-accent-light)] text-accent-base font-medium">
 ...
 <div>
 <div className="text-sm font-medium text-content">{t('homepage.workspaces.visual.shared')}</div>
 <div className="text-xs text-content-tertiary">{t('homepage.workspaces.visual.sharedMembers')}</div>
 </div>
 </div>
 <div className="flex -space-x-2">
 <div className="w-6 h-6 rounded-full bg-surface-alt border-2 border-[var(--color-bg-elevated)]"></div>
 <div className="w-6 h-6 rounded-full bg-surface-alt border-2 border-[var(--color-bg-elevated)]"></div>
 <div className="w-6 h-6 rounded-full bg-surface-alt border-2 border-[var(--color-bg-elevated)] flex items-center justify-center">
 <span className="text-[10px] text-content-tertiary">+2</span>
 </div>
 </div>
 </div>
 ...
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-lg bg-surface-alt flex items-center justify-center">
 <HiOutlineBuildingOffice2 className="w-4 h-4 text-content-secondary" />
 </div>
 <div>
 <div className="text-sm font-medium text-content">{t('homepage.workspaces.visual.business')}</div>
 <div className="text-xs text-content-tertiary">{t('homepage.workspaces.visual.businessMembers')}</div>
 </div>
 </div>
 <div className="flex -space-x-2">
 <div className="w-6 h-6 rounded-full bg-surface-alt border-2 border-[var(--color-bg-elevated)]"></div>
 ...
 <div className="w-6 h-6 rounded-full bg-surface-alt border-2 border-[var(--color-bg-elevated)]"></div>
 <div className="w-6 h-6 rounded-full bg-surface-alt border-2 border-[var(--color-bg-elevated)] flex items-center justify-center">
 <span className="text-[10px] text-content-tertiary">+5</span>
 </div>
 </div>
 </div>
 </div>
 ...
 plan.featured
 ? 'border-[var(--color-accent)] bg-elevated shadow-sm'
