...
export const CategoryDetail: React.FC = () => {
 ...
 <div className="bg-[var(--color-danger-light)] text-danger-base-border border-[var(--color-border)] border rounded-lg p-6">
 ...
 {/* Recent Items */}
 {items.length > 0 && (
 <div className="bg-elevated rounded-lg theme-shadow border-[var(--color-border)] border">
 ...
 <table className="min-w-full border-[var(--color-border)] divide-y">
