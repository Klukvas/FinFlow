...
export const PaymentHistory: React.FC = () => {
 ...
 <div className="w-12 h-12 bg-gradient-to-r from-accent-base to-purple-500 rounded-lg flex items-center justify-center">
 ...
 <p className="text-content-secondary">{t('payment.historyDescription')}</p>
 </div>
 </div>
