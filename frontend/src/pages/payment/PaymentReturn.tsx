...
const STATUS_CONFIG = {
 ...
 gradient: "from-success-base to-teal-500",
 },
 ...
 gradient: "from-danger-base to-rose-500",
 },
 ...
 gradient: "from-warning-base to-warning-base",
 },
 ...
 gradient: "from-accent-base to-indigo-500",
 },
 ...
 gradient: "from-surface-alt to-slate-500",
 },
};
...
export const PaymentReturn: React.FC = () => {
 ...
 <FaSpinner className="w-10 h-10 text-accent-base animate-spin" />
 </div>
 <h1 className="text-2xl font-bold text-white mb-2">
 {t("payment.checkingStatus")}
 </h1>
 <p className="text-content-tertiary mb-4">{t("payment.pleaseWait")}</p>
 ...
 >
 <div className="w-20 h-20 rounded-full bg-[var(--color-danger-light)] flex items-center justify-center mx-auto mb-6">
 <FaTimesCircle className="w-10 h-10 text-danger-base" />
 </div>
 <h1 className="text-2xl font-bold text-white mb-2">
 ...
 {payment.paid_at && (
 <div className="flex items-center justify-between">
 <span className="text-content-tertiary">{t("payment.paidAt")}</span>
 ...
 <FaClock className="w-5 h-5 text-warning-base flex-shrink-0 mt-0.5" />
