...
export const Profile = () => {
 ...
 <div className="w-24 h-24 bg-[var(--color-accent-light)] rounded-full flex items-center justify-center">
 <FaUser className="w-12 h-12 text-accent-base" />
 </div>
 </div>
 ...
 <FaWallet className="w-5 h-5 text-content-tertiary" />
 <div>
 ...
 <div className="space-y-4">
 <div className="flex items-center space-x-3">
 <FaEnvelope className="w-5 h-5 text-content-tertiary" />
 <div>
 <p className="text-sm font-medium text-content-tertiary">
 {t("common.email")}
 </p>
 ...
 <div className="flex items-center space-x-3">
 <FaCalendarAlt className="w-5 h-5 text-content-tertiary" />
 <div>
 <p className="text-sm font-medium text-content-tertiary">
 {t("profile.userId")}
 </p>
 ...
 <div className="flex items-center space-x-3">
 <FaCrown className="w-5 h-5 text-content-tertiary" />
 <div>
 <p className="text-sm font-medium text-content-tertiary">
 ...
 <span className="text-content font-medium capitalize">
 ...
 <div className="flex-shrink-0">
 <div className="w-8 h-8 bg-[var(--color-success-light)] rounded-full flex items-center justify-center">
 <FaUser className="w-4 h-4 text-success-base" />
 </div>
 </div>
 <div className="ml-4">
 <p className="text-sm font-medium text-content-tertiary">
 ...
 <div className="flex items-center">
 <div className="flex-shrink-0">
 <div className="w-8 h-8 bg-[var(--color-accent-light)] rounded-full flex items-center justify-center">
 <FaCalendarAlt className="w-4 h-4 text-accent-base" />
 </div>
 </div>
 <div className="ml-4">
 <p className="text-sm font-medium text-content-tertiary">
 ...
 <div className="flex-shrink-0">
 <div className="w-8 h-8 bg-[var(--color-accent-light)] rounded-full flex items-center justify-center">
 <FaEnvelope className="w-4 h-4 text-accent-base" />
 </div>
 </div>
 <div className="ml-4">
 <p className="text-sm font-medium text-content-tertiary">
 ...
 <div className="space-y-4">
 {error && (
 <div className="bg-[var(--color-danger-light)] border-[var(--color-border)] border text-danger-base rounded-lg p-4">
 <p className="text-danger-base text-sm">{error}</p>
 </div>
 )}

 {success && (
 <div className="bg-[var(--color-success-light)] border-[var(--color-border)] border text-success-base rounded-lg p-4">
