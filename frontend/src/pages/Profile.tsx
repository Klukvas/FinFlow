    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-content-secondary mt-1">{t("profile.subtitle")}</p>
        </div>
      ...
      <div className="bg-elevated rounded-lg theme-shadow border-[var(--border)] border p-6">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-shrink-0">
            <div className="w-24 h-24 bg-[var(--accent-dim)] rounded-full flex items-center justify-center">
              <User className="w-12 h-12 text-accent-base" />
            </div>
          </div>
          ...
          <div className="flex-1 space-y-4">
            <div>
              <h2
                data-testid="profile-user-heading"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Wallet className="w-5 h-5 text-content-tertiary" />
                  <div>
              ...
              <div className="space-y-4">
                ...
                >
                  <Mail className="w-5 h-5 text-content-tertiary" />
                  <div>
                    <p className="text-sm font-medium text-content-tertiary">
                      {t("common.email")}
                    </p>
                    <p data-testid="profile-email" className="text-content">
                      {user?.email}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  <Calendar className="w-5 h-5 text-content-tertiary" />
                  <div>
                    <p className="text-sm font-medium text-content-tertiary">
                      {t("profile.userId")}
                    </p>
                    <p className="text-content">#{user?.id}</p>
                  </div>
                </div>

                <div
                  data-testid="profile-subscription-section"
                  className="flex items-center justify-between"
                >
                  <div className="flex items-center space-x-3">
                    <Crown className="w-5 h-5 text-content-tertiary" />
                    <div>
                      <p className="text-sm font-medium text-content-tertiary">
                      ...
                      {subscriptionLoading ? (
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <span
                              data-testid="profile-plan-code"
                              className="text-content font-medium capitalize"
                            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-elevated rounded-lg theme-shadow border-[var(--border)] border p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-[var(--success-dim)] rounded-full flex items-center justify-center">
                <User className="w-4 h-4 text-success-base" />
              </div>
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-content-tertiary">
        ...
        <div className="bg-elevated rounded-lg theme-shadow border-[var(--border)] border p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-[var(--accent-dim)] rounded-full flex items-center justify-center">
                <Calendar className="w-4 h-4 text-accent-base" />
              </div>
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-content-tertiary">
        ...
        <div className="bg-elevated rounded-lg theme-shadow border-[var(--border)] border p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-[var(--accent-dim)] rounded-full flex items-center justify-center">
                <Mail className="w-4 h-4 text-accent-base" />
              </div>
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-content-tertiary">
      ...
      >
        <div className="space-y-4">
          {error && (
            <div className="bg-[var(--danger-dim)] border-[var(--border)] border text-danger-base rounded-lg p-4">
              <p className="text-danger-base text-sm">{error}</p>
            </div>
          )}

          {success && (
            <div className="bg-[var(--success-dim)] border-[var(--border)] border text-success-base rounded-lg p-4">
              <p className="text-success-base text-sm">{success}</p>
            </div>
          )}
