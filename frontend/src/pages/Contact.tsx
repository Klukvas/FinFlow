        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-8 bg-elevated border-[var(--border)] border rounded-lg p-6">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-3 py-2 border-[var(--border)] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--accent)] bg-surface text-content"
                ...
                <div>
                  ...
                  <textarea
                    rows={6}
                    className="w-full px-3 py-2 border-[var(--border)] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--accent)] bg-surface text-content resize-none"
