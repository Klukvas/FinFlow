    ...
    <div className="min-h-screen bg-surface">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          {/* Quick Steps */}
          <section className="bg-surface-alt p-6 rounded-lg border border-[var(--border)]">
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-surface-alt border border-[var(--border)]">
                <CheckCircle2 className="w-5 h-5 text-success-base flex-shrink-0 mt-0.5" />
                <div>
          ...
          <section>
            ...
            <div className="bg-surface-alt p-6 rounded-lg border border-[var(--border)]">
          ...
          <section className="mt-12">
            <h2 className="text-2xl font-bold text-content mb-4">Need Help?</h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-6 rounded-lg bg-surface-alt border border-[var(--border)]">
                <Mail className="w-8 h-8 text-accent-base mb-4" />
              ...
              <div className="p-6 rounded-lg bg-surface-alt border border-[var(--border)]">
                <MessageSquare className="w-8 h-8 text-accent-base mb-4" />
                <h3 className="text-lg font-semibold text-content mb-2">
                  Live Chat
                </h3>
                <p className="text-content-secondary mb-4">
