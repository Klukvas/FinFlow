      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2.5 bg-accent-base text-white rounded-lg font-medium hover:bg-accent-base-hover transition-colors shadow-sm min-h-[44px] touch-manipulation"
          >
