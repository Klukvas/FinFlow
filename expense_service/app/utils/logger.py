...
def get_logger(name: str):
    ...
    return get_structured_logger(name, "expense_service")
...
def log_external_service_call(logger, service: str, endpoint: str, status_code: int, duration_ms: Optional[float] = None, details: Optional[str] = None):
    """Log external service calls"""
    logger.log_external_service_call(service, endpoint, status_code, duration_ms, details)
